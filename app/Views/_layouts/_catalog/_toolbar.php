<div id="kt_app_toolbar" class="d-flex flex-wrap flex-stack mb-8 mb-lg-2">
    ...
    <div class="d-flex gap-3">
        <form method="get" action="<?= site_url('/') ?>">
            <div class="d-flex align-items-center position-relative">
                <i class="ki-outline ki-magnifier fs-4 position-absolute ms-3"></i> <input type="text" class="form-control border-body bg-body ps-10" placeholder="Cari" name="keyword">
            </div>
        </form>
        <a href="#" class="btn btn-flex btn-danger fw-bold" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
        ...
        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_673c0c93de9e8">
            ...
            <div class="px-7 py-5">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-sm btn-danger" data-kt-menu-dismiss="true">Terapkan</button>
                    </form>
                </div>
            </div>
        </div>
