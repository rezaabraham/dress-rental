    ...
    <div class="app-container container-xxl d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="app-navbar flex-shrink-0">
            <div class="app-navbar-item ms-3 ms-lg-5">
                <a href="#" class="btn btn-sm btn-outline btn-outline-primary"><i class="ki-outline ki-calendar-tick fs-3 me-1"></i>Jadwal</a>
            </div>
            <div class="app-navbar-item d-lg-none ms-2 me-n3" title="Tampilkan Menu">
                <div class="btn btn-sm btn-icon btn-outline btn-outline-dark btn-active-light-dark" id="kt_app_header_menu_toggle">
